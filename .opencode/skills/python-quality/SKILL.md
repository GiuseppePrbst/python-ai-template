...
- Crear o modificar código Python del paquete (`src/<nombre_paquete>/`) o de los tests (`tests/`).
...
- Layout `src/`: el código del paquete vive en `src/<nombre_paquete>/`.
...
- API pública: lo declarado en `src/<nombre_paquete>/__init__.py`. Cambios en la API pública requieren ADR.
